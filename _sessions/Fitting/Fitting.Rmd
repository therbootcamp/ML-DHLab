...
<div class="my-footer">
  <span style="text-align:center">
    ...
    <a href="https://therbootcamp.github.io/">
      <font color="#7E7E7E">
       Machine Learning with R | November 2019
      </font>
    </a>
    </span>
  </div> 
...
<ul style="margin-bottom:-20px">
  <li class="m1"><span>In logistic regression, the class criterion <font style="font-size:22px"><mono>y &isin; (0,1)</mono></font> is modeled also as the <high>sum of feature times weights</high>, but with the prediction being transformed using a <high>logistic link function</high>:</span></li>
</ul>
...
<ul style="margin-bottom:-20px">
  <li class="m2"><span>
The logistic function <high>maps predictions to the range of 0 and 1</high>, the two class values.</span></li>
</ul>
...
<ul style="margin-bottom:-20px">
  <li class="m1"><span><b>Distance</b></span></li>
  <ul class="level">
...
<ul>
  <li class="m2"><span><b>Agreement</b></span></li>
  <ul class="level">
...
<ul>
  <li class="m1"><span>Controls how <mono>caret</mono> fits an ML model.</span></li>
...
<ul>
  <li class="m1"><span><high>Gives a summary</high> of a models' performance in a <high>classification task</high.</span></li>
  <li class="m2"><span>Specify redicted values and the true values inside the function.</span></li>
</ul>
...
```{r, eval = F}
# eyecor to factor
basel$eyecor <- factor(basel$eyecor)
